...
export class AiService {
  ...
  private async performDeepResearch(
    ...
    const empathyInstruction = mpName
      ? `Research ${mpName}'s background, voting record, stated priorities, and public statements to find angles that will help them empathise with this issue. Highlight any shared values, constituency projects, or previous interventions they have championed that align with the constituent's situation.`
      : `Research the MP's background, voting record, stated priorities, and public statements to uncover angles that will help them empathise with the constituent's issue. Highlight shared values, constituency projects, or previous interventions that align with the situation.`;
